...
Channel.value(params.mate).set{g_2_1_g76_23}
(g_2_0_g76_31,g_2_0_g76_30,g_2_1_g72_26,g_2_1_g72_30,g_2_1_g72_46,g_2_1_g71_11,g_2_1_g71_16,g_2_1_g71_21,g_2_1_g71_24,g_2_0_g71_28,g_2_0_g71_31,g_2_1_g71_18,g_2_1_g71_23,g_2_1_g71_19,g_2_1_g71_20,g_2_1_g74_82,g_2_1_g74_95,g_2_0_g74_131,g_2_1_g74_133,g_2_1_g73_10,g_2_1_g73_3) = [g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23,g_2_1_g76_23]
Channel.value(params.run_FeatureCounts).set{g_85_0_g74_125}
...
output:
 val run_params  ,emit:g74_125_run_parameters02_g74_133 
...
sense_antisense = params.BAM_Analysis_Module_featureCounts_Prep.sense_antisense
...
output:
 path "*/${gtf2}" ,optional:true  ,emit:g78_54_gtfFile03_g74_133 
...
output:
 ...
 tuple val(oldname), file("*_sorted*bam")  ,emit:g73_4_sorted_bam20_g76_22 
...
output:
 tuple val(name), file("bam/${name}.bam")  ,emit:g76_22_mapped_reads01_g76_30 
 tuple val(name), file("${name}*")  ,emit:g76_22_publish11 
 path "*_duplicates_stats.log"  ,emit:g76_22_log_file20_g76_23 
...
output:
 path "bed/${name}.bed"  ,emit:g76_30_bed02_g76_31 
...
mv ${bam} bam/${name}.bam
bedtools slop -s -i ${name}.bed -l 9 -r 0 -g ${genome_sizes} | grep "-" | awk -v OFS="\t" '{print \$1,\$3-29,\$3,\$4,\$5,\$6}' >> ${name}.adjust.bed
bedtools slop -s -i ${name}.bed -l 9 -r 0 -g ${genome_sizes} | grep "+" | awk -v OFS="\t" '{print \$1,\$2,\$2+29,\$4,\$5,\$6}' >> ${name}.adjust.bed
...
output:
 path "*.bed"  ,emit:g76_31_bed00_g76_26 
...
output:
 path "result/*.out"  ,emit:g74_134_outputFileOut00_g74_95 
...
output:
 path "*.tsv"  ,emit:g74_95_outputFileTSV00 
...
output:
 path "*"  ,emit:g74_133_outputFileTSV00_g74_117 
...
output:
 path "*_featureCounts.tsv"  ,emit:g74_117_outputFile00 
 path "*_featureCounts.sum.tsv"  ,emit:g74_117_outFileTSV11 
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /merged.bed$/) "atac/$filename"}
input:
 path bed
 path genome_sizes

output:
 path "merged.bed"  ,emit:g76_26_bed01_g76_27 
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /.*.sum.txt$/) "atac/$filename"}
input:
 val compare_bed
 path bed
 tuple val(name), file(bam)
...
output:
 path "*.sum.txt"  ,emit:g76_27_outputFileTxt00_g76_13 
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /.*.tsv$/) "atac_summary/$filename"}
input:
 path file

output:
 path "*.tsv"  ,emit:g76_13_outputFile00 
...
output:
 path "deduplication_summary.tsv"  ,emit:g76_23_outputFileTSV08_g_75 
...
BAM_Analysis_Module_featureCounts_Prep(g_85_0_g74_125)
g74_125_run_parameters02_g74_133 = BAM_Analysis_Module_featureCounts_Prep.out.g74_125_run_parameters02_g74_133
...
g78_54_gtfFile03_g74_133 = Check_and_Build_Module_check_files.out.g78_54_gtfFile03_g74_133
(g78_54_gtfFile01_g72_47) = [g78_54_gtfFile03_g74_133]
...
(g78_54_genomeSizes21_g74_142,g78_54_genomeSizes22_g76_30,g78_54_genomeSizes21_g76_26) = [g78_54_genomeSizes22_g74_131,g78_54_genomeSizes22_g74_131,g78_54_genomeSizes22_g74_131]
...
g72_46_bowfiles15_g_70 = Channel.empty()
...
(g72_46_bowfiles15_g_70) = [g72_46_bowfiles10_g72_26]
...
g73_4_sorted_bam20_g76_22 = Bowtie2_Module_Merge_Bam.out.g73_4_sorted_bam20_g76_22
...
g73_4_sorted_bam20_g76_22.set{g76_22_mapped_reads01_g76_30}
g76_22_publish11 = Channel.empty()
g76_22_log_file20_g76_23 = Channel.empty()
} else {

ATAC_Module_Picard_MarkDuplicates(g73_4_sorted_bam20_g76_22)
g76_22_mapped_reads01_g76_30 = ATAC_Module_Picard_MarkDuplicates.out.g76_22_mapped_reads01_g76_30
g76_22_publish11 = ATAC_Module_Picard_MarkDuplicates.out.g76_22_publish11
g76_22_log_file20_g76_23 = ATAC_Module_Picard_MarkDuplicates.out.g76_22_log_file20_g76_23
}


ATAC_Module_ATAC_Prep(g_2_0_g76_30,g76_22_mapped_reads01_g76_30,g78_54_genomeSizes22_g76_30)
g76_30_bed02_g76_31 = ATAC_Module_ATAC_Prep.out.g76_30_bed02_g76_31
g76_30_bam_file11_g76_31 = ATAC_Module_ATAC_Prep.out.g76_30_bam_file11_g76_31
...
BAM_Analysis_Module_RSeQC(g76_31_bam_file10_g74_134,g78_54_bed31_g74_134)
g74_134_outputFileOut00_g74_95 = BAM_Analysis_Module_RSeQC.out.g74_134_outputFileOut00_g74_95
(g74_134_outputFileOut08_g_70) = [g74_134_outputFileOut00_g74_95]


BAM_Analysis_Module_RSeQC_Summary(g74_134_outputFileOut00_g74_95.collect(),g_2_1_g74_95)
g74_95_outputFileTSV00 = BAM_Analysis_Module_RSeQC_Summary.out.g74_95_outputFileTSV00


BAM_Analysis_Module_featureCounts(g76_31_bam_file10_g74_133,g_2_1_g74_133,g74_125_run_parameters02_g74_133,g78_54_gtfFile03_g74_133)
g74_133_outputFileTSV00_g74_117 = BAM_Analysis_Module_featureCounts.out.g74_133_outputFileTSV00_g74_117


BAM_Analysis_Module_summary_featureCounts(g74_133_outputFileTSV00_g74_117.collect())
g74_117_outputFile00 = BAM_Analysis_Module_summary_featureCounts.out.g74_117_outputFile00
g74_117_outFileTSV11 = BAM_Analysis_Module_summary_featureCounts.out.g74_117_outFileTSV11


BAM_Analysis_Module_IGV_BAM2TDF_converter(g_2_0_g74_131,g76_31_bam_file11_g74_131,g78_54_genomeSizes22_g74_131)
g74_131_outputFileOut00 = BAM_Analysis_Module_IGV_BAM2TDF_converter.out.g74_131_outputFileOut00


BAM_Analysis_Module_Picard(g76_31_bam_file10_g74_121)
...
ATAC_Module_bed_merge(g76_31_bed00_g76_26.collect(),g78_54_genomeSizes21_g76_26)
g76_26_bed01_g76_27 = ATAC_Module_bed_merge.out.g76_26_bed01_g76_27


ATAC_Module_bedtools_coverage(g76_31_compare_bed20_g76_27,g76_26_bed01_g76_27,g76_31_bam_file12_g76_27)
g76_27_outputFileTxt00_g76_13 = ATAC_Module_bedtools_coverage.out.g76_27_outputFileTxt00_g76_13


ATAC_Module_ATAC_CHIP_summary(g76_27_outputFileTxt00_g76_13.collect())
g76_13_outputFile00 = ATAC_Module_ATAC_CHIP_summary.out.g76_13_outputFile00


ATAC_Module_Picard_Deduplication_Summary(g76_22_log_file20_g76_23.collect(),g_2_1_g76_23)
g76_23_outputFileTSV08_g_75 = ATAC_Module_Picard_Deduplication_Summary.out.g76_23_outputFileTSV08_g_75
...
g76_23_outputFileTSV08_g_75= g76_23_outputFileTSV08_g_75.ifEmpty(ch_empty_file_6) 


Overall_Summary(g73_11_outputFileTSV00_g_75,g72_14_outputFileTSV01_g_75,g71_11_outputFileTSV05_g_75,g71_21_outputFileTSV06_g_75,g71_16_outputFileTSV07_g_75,g76_23_outputFileTSV08_g_75)
g_75_outputFileTSV00 = Overall_Summary.out.g_75_outputFileTSV00


MultiQC(g71_28_FastQCout04_g_70.flatten().toList(),g72_46_bowfiles15_g_70.flatten().toList(),g74_134_outputFileOut08_g_70.flatten().toList(),g76_31_resultsdir310_g_70.flatten().toList(),g73_3_bowfiles312_g_70.flatten().toList(),g71_31_FastQCout015_g_70.flatten().toList())
